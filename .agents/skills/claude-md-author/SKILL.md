...
description: >
  Create, edit, and improve AGENTS.md files for Codex projects. Use this skill when asked to
  write, audit, refactor, or optimize a AGENTS.md (or Codex.local.md) file. Produces files that
  make Codex sessions dramatically more effective by encoding institutional knowledge,
